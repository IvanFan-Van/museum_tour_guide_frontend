...
export default function ScannerPage({
    ...
    return (
        <div className="flex relative h-full w-full">
            <button onClick={() => setScannerMode(false)} className="flex opacity-80 absolute m-4 z-20 items-center justify-center rounded-full transition-all duration-200 bg-[#252733] hover:bg-gray-500 size-16">
                <img src={BackArrow} className="size-10" />
            </button>
            <div className={`fixed inset-0 z-10 size-[30vh] m-auto aspect-square border-2 border-dashed border-red-600 rounded-lg`}>
